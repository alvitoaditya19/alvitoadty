    ...
    return (
        <div className="featured-game-card relative">
            <a href="./src/detail.html">
                ...
                <div className="cover absolute bottom-0 m-8">
                    <div className="flex flex-col h-24 justify-between text-decoration-none">
                        ...
                        <div className='mt-4'>
                            <p className="font-semibold text-white text-xl m-0">{name}</p>
                            <p className="font-light text-white m-0">{category}</p>
                        </div>
                    </div>
                </div>
            </a>
