...
export default function ProjectItem({ image, name, category, id }: ProjectTypes) {
  return (
    <div className="w-full md:w-1/2 px-4 rounded-2xl md:mb-0 mb-[40px]">
      <div className="item md:w-[400px] flex flex-col items-center justify-end whitespace-normal bg-kBackgroundColor2 rounded-2xl relative">
        <div className="relative group overflow-hidden">
          ...
          <div className="absolute top-0 right-0 p-2 rounded-bl-2xl bg-kBackgroundColor2 rounded-tr-2xl">
        ...
        <div>
          <p className="mt-[20px] relative text-xl text-white mb-2 text-center font-medium line-clamp1" style={{ wordWrap: 'break-word' }}>
            {name}
          </p>
        </div>
        <p className="text-xl text-kGreyColor mb-[40px] text-center">
          {category}
        </p>
