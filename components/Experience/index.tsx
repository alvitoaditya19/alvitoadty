...
export default function Experience() {
    return (
        <section className="container-fluid bg-kBackgroundColor mx-auto w-full h-full lg:py-10 py-8">
            ...
            <div className="relative wrap overflow-hidden p-2 h-full">
                ...
                <div className="mb-8 flex justify-between items-center w-full right-timeline" style={{ textAlign: 'justify' }}>
                    ...
                    <div className="order-1  rounded-lg  md:w-4/12 w-full px-6 py-4 bg-kBackgroundColor2">
                        <time className="mb-1 text-sm font-normal leading-none text-kGreyColor">Sept 2022 – Jun 2023</time>
                        <h3 className="md:text-lg text-base font-semibold text-white dark:text-white mt-2">Electrical Laboratory UIN Bandung</h3>
                        <p className="md:text-base text-xs font-normal text-white mt-2">Laboratory Assistant For Microcontroller System Practicum and Mobile Programming Course</p>

                        <p className="md:text-base text-xs font-normal text-kGreyColor mt-2">Provide technical support and guidance to students in setting up, configuring, troubleshooting, and understanding microcontroller systems for practical experiments and mobile programming practical, while collaborating with the instructor to develop relevant lab assignments and maintaining the laboratory environment.</p>
                    </div>
                ...
                <div className="mb-8 flex justify-between items-center w-full right-timeline" style={{ textAlign: 'justify' }}>
                    ...
                    <div className="order-1  rounded-lg  md:w-4/12 w-full px-6 py-4 bg-kBackgroundColor2">
                        <time className="mb-1 text-sm font-normal leading-none text-kGreyColor">Mar 2022 – Jul 2022</time>
                        <h3 className="md:text-lg text-base font-semibold text-white dark:text-white mt-2">PT. Kreasi Rekayasa Indonesia (KIREI)</h3>
                        <p className="md:text-base text-xs font-normal text-white mt-2">Project Internship</p>

                        <p className="md:text-base text-xs font-normal text-kGreyColor mt-2">
