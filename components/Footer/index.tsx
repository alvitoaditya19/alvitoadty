      ...
      <footer>
        <div className="container-fluid bg-kBackgroundColor2">
            ...
            <div className="flex flex-wrap justify-start items-center -mx-4 ">
              <div className="w-6/6 md:w-2/6 px-4 mb-8 md:mb-0">
                ...
                <p className="mt-30 text-lg text-white mb-30">
              ...
              <div className="w-6/6 md:w-4/6 px-4 mb-8 md:mb-0">
                <div className="row">
                  <div className="w-3/6 md:w-2/6 px-4 col-6 mb-lg-0 mb-25">
                    <p className="text-lg fw-semibold text-white mb-12">
                      Company
                    </p>
                  ...
                  <div className="w-3/6 md:w-2/6 px-4 col-12 mt-lg-0 mt-md-0 mt-25">
                    <p className="text-lg fw-semibold text-white mb-12">
                      Connect
                    </p>
                    <ul className="list-unstyled">
